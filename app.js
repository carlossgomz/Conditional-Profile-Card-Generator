          ...
          variables.country ? variables.country : "Country"
                ...
                <ul class="${variables.socialMediaPosition}">
                  <li><a target="_blank" href="https://twitter.com/${
                    variables.twitter ? variables.twitter : "Twitter User"
                  }"><i class="fab fa-twitter"></i></a></li>
                  <li><a target="_blank" href="https://github.com/${
                    variables.github ? variables.github : "Github User"
                  }"><i class="fab fa-github"></i></a></li>
                  <li><a target="_blank" href="https://linkedin.com/${
                    variables.linkedin ? variables.linkedin : "Linked In User"
                  }"><i class="fab fa-linkedin"></i></a></li>
                  <li><a target="_blank" href="https://instagram.com/${
                    variables.instagram ? variables.instagram : "Instagram User"
